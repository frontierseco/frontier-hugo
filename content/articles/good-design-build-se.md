...
Design-build involves shared risk. A good design-build SE is honest about structural risk — conditions that require investigation before they can be designed to, assumptions that carry uncertainty, details that are at the edge of the SE's experience. Hiding risk to appear more capable or to avoid difficult conversations doesn't serve the team.
