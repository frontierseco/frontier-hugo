...
- Whether the design complies with the applicable code and referenced standards
...
- Lenders or owners for complex or high-value projects
- Developers who are self-performing design review and want independent validation
- Contractors in design-build who want confirmation that the design they're building to is correct before they're committed

## What Peer Review Protects
...
## What Makes a Useful Peer Review

The quality of a peer review depends on the reviewer's expertise in the structural system being reviewed, the reviewer's familiarity with the applicable code, and the rigor with which the review is performed. A peer review that generates three comments on a complex PT concrete mid-rise either missed something or was not thorough.
